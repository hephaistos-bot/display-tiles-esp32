...
* **Component Addresses:**
  * **CH422G (IO Expander):** 
    ...
    * `0x27`: EXIO Byte-Write
    * `0x38`: OC (Open-Drain) Byte-Write
...
* **Chip Select (CS):** Managed by CH422G EXIO4 (Active Low).
...
| EXIO6 | - | Reserved | Unassigned. |
| EXIO7 | - | Reserved | Unassigned. |
...
* **Digital Inputs (DI0, DI1):** Mapped to **EXIO0** and **EXIO5**. These support 5V–36V signals.
...
3. Command CH422G to pull EXIO4 (SD_CS) LOW.
